...
import io.github.sgpublic.dormnet.generated.resources.app_opensource
...
val LocalLoginPageViewModel = staticCompositionLocalOf<LoginPageViewModel> {
    error("CompositionLocal LocalLoginPageViewModel not present")
}
...
fun LoginPage() {
    ...
    CompositionLocalProvider(
        LocalLoginPageViewModel provides loginPageViewModel
    ) {
        Scaffold(
            snackbarHost = {
                SnackbarHost(
            ...
            Box(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Row {
                            Text(
                                text = "${stringResource(Res.string.app_opensource)} ",
                    ...
                    if (school == null) {
                        ...
                        val viewModel = viewModel(key = school.name) {
                            school.impl.createViewModel()
                        }
                        CompositionLocalProvider(
                            LocalDormnetViewModel provides viewModel
                        ) {
                            school.impl(loginPageViewModel.loading) {
                                loginPageViewModel.loading = it
                            }
